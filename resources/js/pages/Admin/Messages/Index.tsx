...
const AdminMessagesIndex: React.FC<Props> = ({ messages, auth, flash, breadcrumbs, filters }) => {
    ...
    const confirmDelete = () => {
        ...
        // Use Ziggy or manual URL: destroy(route('messages.destroy', messageToDelete), { ... });
        destroy(`/messages/${messageToDelete}`, {
            preserveScroll: true,
            preserveState: false,
            onSuccess: () => {
                toast.success('Message deleted successfully.');
                setMessageToDelete(null);
                // Optional: Close expanded view if the deleted message was expanded
                    ...
                    <AlertDialog open={messageToDelete !== null} onOpenChange={(isOpen) => !isOpen && cancelDelete()}>
                        <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                    disabled={processing} onClick={confirmDelete}
